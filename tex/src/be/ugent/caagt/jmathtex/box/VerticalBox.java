...
public class VerticalBox extends Box {
    ...
    public String toString() {
    	return "VerticalBox{children=" + super.children + "}";
    }
    ...
    /**
     * XML:
     *   <VerticalBox leftMostPos=float rightMostPos=float>
     *     <Box> ...基类的... </Box>
     *   </VerticalBox>
     */
    public void toXml(SimpleXmlWriter sxw, Object hint) {
    	sxw.appendRaw("<VerticalBox")
    	   .blank().attribute("leftMostPos", leftMostPos)
    	   .blank().attribute("rightMostPos", rightMostPos);
    	super.addAttr(sxw);
    	sxw.appendRaw(">").ln();
    	
    	super.addChildren(sxw);
    	
    	sxw.endElement("VerticalBox");
    }
}
