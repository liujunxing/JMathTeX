...
public class GlueBox extends Box {
   ...
   public String toString() {
	   return "GlueBox{width=" + this.width + "}";
   }
   ...
   /**
    * XML:
    *   <GlueBox stretch=xxx shrink=xxx>
    *     <Box> ...基类的 </Box>
    *   </GlueBox>
    */
   public void toXml(SimpleXmlWriter sxw, Object hint) {
	   sxw.appendRaw("<GlueBox")
	      .blank().attribute("stretch", stretch)
	      .blank().attribute("shrink", shrink);
	   super.addAttr(sxw);
	   sxw.appendRaw(">").ln();
	   
	   super.addChildren(sxw);
	   
	   sxw.endElement("GlueBox").ln();
   }
}
