...
public class SpaceAtom extends Atom {
    ...
    public String toString() {
    	return "SpaceAtom{width=" + width + ", height=" + height + ", depth=" + depth + "}";
    }
    ...
    /**
     * 生成 XML:
     *   <SpaceAtom blankSpace=bool width=float height=float depth=float wUnit=int hUnit=int dUnit=int>
     *     <Atom> ... </Atom>
     *   </SpaceAtom>
     */
    public void toXml(SimpleXmlWriter sxw, Object hint) {
    	sxw.appendRaw("<SpaceAtom ")
    		.attribute("blankSpace", blankSpace).blank()
    		.attribute("width", width).blank()
    		.attribute("height", height).blank()
    		.attribute("depth", depth).blank()
    		.attribute("wUnit", wUnit).blank()
    		.attribute("hUnit", hUnit).blank()
    		.attribute("dUnit", dUnit).appendRaw(">").ln();
    	
    	super.superToXml(sxw);
    	
    	sxw.endElement("SpaceAtom").ln();
    }
}
