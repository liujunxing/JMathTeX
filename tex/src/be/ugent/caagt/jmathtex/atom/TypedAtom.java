...
public class TypedAtom extends Atom {
   ...
   public String toString() {
	   return "TypedAtom{atom=" + atom + ", leftType=" + leftType + ", rightType=" + rightType + "}";
   }
   ...
   public void toXml(SimpleXmlWriter sxw, Object hint) {
	   sxw.appendRaw("<TypedAtom ")
	   		.attribute("leftType", leftType).blank()
	   		.attribute("rightType", rightType).blank()
	   		.appendRaw(">").ln();
	   
	   super.superToXml(sxw);
	   
	   if (atom != null) {
		   sxw.beginElement("atom").ln();
		   atom.toXml(sxw, hint);
		   sxw.endElement("atom").ln();
	   }
	   
	   sxw.endElement("TypedAtom").ln();
   }
}
