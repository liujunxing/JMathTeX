...
public class UnderOverAtom extends Atom {
    ...
    public String toString() {
    	return "UnderOverAtom{base=" + base + ", under=" + under + ", over=" + over + "}";
    }
    ...
    /**
     * XML:
     *   <UnderOverAtom underSpace=float overSpace=float underUnit=int overUnit=int underScriptSize=int overScriptSize=int>
     *     <Atom> base class </Atom>
     *     <base> ... </base>
     *     <under> ... </under>
     *     <over> ... </over>
     *   </UnderOverAtom>
    ...
    public void toXml(SimpleXmlWriter sxw, Object hint) {
    	sxw.appendRaw("<UnderOverAtom").blank()
    		.attribute("underSpace", underSpace).blank()
    		.attribute("overSpace", overSpace).blank()
    		.attribute("underUnit", underUnit).blank()
    		.attribute("overUnit", overUnit).blank()
    		.attribute("underScriptSize", underScriptSize).blank()
    		.attribute("overScriptSize", overScriptSize).appendRaw(">").ln();
    	...
    	sxw.endElement("UnderOverAtom").ln();
    }
}
